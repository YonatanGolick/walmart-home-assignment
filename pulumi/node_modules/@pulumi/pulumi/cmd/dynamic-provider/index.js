...
function streamInvokeRPC(call, callback) {
    return __awaiter(this, void 0, void 0, function* () {
        const req = call.request;
        // TODO[pulumi/pulumi#406]: implement this.
        callback(new Error(`unknown function ${req.getTok()}`), undefined);
...
function checkConfigRPC(call, callback) {
    callback({
...
function diffConfigRPC(call, callback) {
    callback({
        code: grpc.status.UNIMPLEMENTED,
...
function getSchemaRPC(call, callback) {
    callback({
        code: grpc.status.UNIMPLEMENTED,
        details: "GetSchema is not implemented by the dynamic provider",
    }, undefined);
}
function constructRPC(call, callback) {
    callback({
        code: grpc.status.UNIMPLEMENTED,
